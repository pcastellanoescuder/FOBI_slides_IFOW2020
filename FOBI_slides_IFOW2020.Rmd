...
# Aims
  ...
  .font130[
  - Clearly define the many complex relationships between diet derived **metabolites** and **foods** in a consistent and homogeneous way
  ]

--

  .font130[
  - Annotation of terms using a consistent and standardized nomenclature 
    - FoodOn 
    - ChEBI
  ]
...
## Properties
  ...
  - _Contains_ and _HasIngredient_ (within Food sub-ontology, to relate raw and multi-component foods)
